    ...
    public class UvRegionEditor : EditorWindow
    {
        ...
        private void HandleResize()
        {
            for (int i = 0; i < resizeHandles.Length; i++)
            {
                ...
                var fmh_1520_73_638856120655295368 = Quaternion.identity; Vector3 newHandlePosition = Handles.FreeMoveHandle(pos, 10f, Vector2.zero, Handles.RectangleHandleCap);
                if (EditorGUI.EndChangeCheck())
                {
